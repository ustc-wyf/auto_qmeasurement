...
data=loadData(filename,5)#spectrum of pump: 11, spectrum of second harmonic: 17
length=len(data)
x=[]
for i in range(length):
...
p1=zeroline[int((pos[ind]-bottom)/widthx)]
p2=p1-amp[ind]
t=p2/p1
print('zeroline:'+str(zeroline[int((pos[ind]-bottom)/widthx)]))
print('position:'+str(pos[ind]))
print('amp:'+str(amp[ind]))
print('t:'+str(t))
print('FWHM:'+str(sig[ind])+'GHz')
